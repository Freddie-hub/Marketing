...
function ContactSection() {
  return (
    <div>
    <Navbar/>
    <section className="section contact bg-white-2" id="contact" aria-label="contact">
      <div className="container">

        <h2 className="h2 section-title text-center text-3xl font-bold mt-7">Connect With Us</h2>

        <form action="" className="contact-form bg-white-1 p-20 rounded-radius-2 mb-30 shadow-shadow-1">

          <div className="input-wrapper">
            <input type="text" name="name" aria-label="name" placeholder="Your name*" required className="input-field bg-white-2 text-eerie-black text-fs-5 p-15 rounded-radius-2 outline-none mb-15" />
